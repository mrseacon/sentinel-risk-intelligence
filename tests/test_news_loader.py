from sentinel.ai.news_loader import NewsItem, build_headlines_text, build_markdown_news_list


def test_build_headlines_text():
    items = [
        NewsItem(title="AAPL earnings beat expectations", source="Reuters", published=None, link="https://example.com/a"),
        NewsItem(title="Fed signals rate pause", source="Bloomberg", published="Mon, 01 Jan 2026", link="https://example.com/b"),
    ]
